...
venue: "NHS Library and Knowledge Services, Health Education England"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Jun 22 and 24, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Simon Waldman", "Marco Crotti", "Owen Stephens", "Brian Gue"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Lucy Whalley", "James Knight", "Sangeeta Bhatia", "Haroon Chughtai"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
